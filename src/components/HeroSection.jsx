...
const HeroSection = () => {
  ...
  return (
    <>
      <section
        id="home"
        className="rr-hero-area rr-hero-bg pt-120 pb-120 p-relative"
      >
            ...
            <div className="row gx-30">
              ...
              <div className="col-xl-7 col-lg-7 col-md-12">
                <div className="rr-hero-banner">
                  <h6
                    className="rr-hero-subtitle wow rrfadeUp"
                  ...
                  <h2
                    className="rr-hero-title wow rrfadeUp"
                    data-wow-duration=".9s"
                    data-wow-delay=".5s"
                  >
                  ...
                  <p
                    ...
                    data-wow-delay=".7s"
                  >
                    At Y&D Bridal Luxe, we help you achieve your dream wedding
                    and make any event unforgettable. From organizing family
                    gatherings to managing appointments with suppliers, we
                    handle everything for you.
                    <br />
                    Whether it's a wedding, corporate event, or private
                    celebration, we ensure every detail is taken care of.
                  </p>

                  <div className="rr-hero-banner-info d-flex align-items-center">
                    <div
                      className="rr-hero-banner-btn mr-35 wow rrfadeUp"
                      data-wow-duration=".9s"
                      data-wow-delay=".9s"
                    >
                      <a
              ...
              <div className="col-xl-5 col-lg-5 col-md-10 col-sm-10 col-12 p-relative">
                <div className="rr-hero-thumb text-end">
                  ...
                  <div
                    className="rr-hero-main-thumb wow rrfadeUp"
                    data-wow-duration=".9s"
                    data-wow-delay=".5s"
                  >
                    <img
                  ...
                  <div
                    className="rr-hero-sm d-none d-xxl-block wow rrfadeRight"
                    data-wow-duration=".9s"
                    data-wow-delay=".3s"
                  >
                    <img
                  ...
                  <div
                    className="rr-hero-border-img wow rrfadeUp"
                    data-wow-duration=".9s"
                    data-wow-delay=".7s"
                  >
